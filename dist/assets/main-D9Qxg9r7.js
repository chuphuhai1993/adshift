...
`,b=`<footer class="bg-[#F5F6F7] text-gray-600 pt-16 pb-8 border-t border-gray-200 mt-auto">
...
</section>`,h=`<!-- Testimonials Section -->
<section class="bg-white">
    
    <div class="container mx-auto relative z-10 py-20 rounded-3xl bg-gradient-to-b from-[#FFFFFF] via-[#8DBCFC]  to-[#69F0FC] z-0 text-center">
 
        <div class="flex items-center justify-center">
            <img src="/assets/icon_title.svg" class="h-5 mr-2">
            <span class="text-md text-black opacity-80 tracking-wider">Testimonials</span>
        </div>
        <h2 class="text-3xl md:text-4xl font-bold mt-2 mb-16">Don't just take our word for it. See what our customers say.</h2>
         
         <div class="relative overflow-hidden w-full mask-gradient">
            <div class="flex w-max animate-scroll pause-on-hover gap-6">
                <!-- Original 5 Reviews -->
                <!-- Review 1 -->
                <div class="w-[400px] bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/40 transition">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center font-bold text-white">M</div>
                        <div>
                ...
                <div class="w-[400px] bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/40 transition"> 
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center font-bold text-white">A</div>
                        <div>
                    ...
                    <p class="text-sm text-black opacity-60 leading-relaxed text-left">
                        "ADShift has completely transformed how we manage our ad spend. The agency accounts are stable and the support team is incredible. Highly recommended for any business looking to scale."
                    </p>
                </div>
                <!-- Review 3 -->
                <div class="w-[400px] bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/40 transition">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="w-10 h-10 rounded-full bg-purple-500 flex items-center justify-center font-bold text-white">S</div>
                        <div>
                    ...
                    <p class="text-sm text-black opacity-60 leading-relaxed text-left">  
                        "Highly recommended for any business looking to scale on TikTok and Meta without the usual headaches of account bans. The process is seamless and efficient."
                    </p>
                </div>
                <!-- Review 4 -->
                <div class="w-[400px] bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/40 transition">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="w-10 h-10 rounded-full bg-orange-500 flex items-center justify-center font-bold text-white">M</div>
                        <div>
                    ...
                    <p class="text-sm text-black opacity-60 leading-relaxed text-left">  
                        "The ROI we've seen since switching to ADShift has been phenomenal. Their strategic insights and robust account infrastructure gave us the confidence to push our budgets."
                    </p>
                </div>
                <!-- Review 5 -->
                <div class="w-[400px] bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/40 transition">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="w-10 h-10 rounded-full bg-pink-500 flex items-center justify-center font-bold text-white">E</div>
                        <div>
                    ...
                    <p class="text-sm text-black opacity-60 leading-relaxed text-left">  
                        "Finally, a partner that understands the nuances of performance marketing. The 24/7 support is a lifesaver, and the transparent reporting makes my job so much easier."
                    </p>
                </div>
...
</section>`,x=`<section class="py-20 bg-white">
...
</section>`,g=`<div class="container mx-auto px-4 relative z-10">
    <div class="mb-12">
        <div class="flex items-center">
            <img src="/assets/icon_title.svg" class="h-5 mr-2">
            <span class="text-md text-black opacity-80 tracking-wider">Our Solutions</span>
        </div>
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mt-2">Grow your presence & drive revenue from scalable campaigns.</h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="p-8 rounded-3xl bg-white card-shadow group">
            ...
            <p class="text-gray-600 text-sm mb-6 line-clamp-3">Access our Google Ads invoice accounts to scale your campaigns efficiently.</p>
            <ul class="space-y-2 mb-8 text-sm text-gray-500">
                <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Competitive rates starting from 3%</li>
                <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Full promo credits up to $384</li>
                <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Multiple billing invoices available</li>
                <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Direct support from Google Account Managers</li>
            </ul>
        ...
        <div class="p-8 rounded-3xl bg-white card-shadow group">
            ...
            <p class="text-gray-600 text-sm mb-6 line-clamp-3">Optimize your Meta ad spend with verified agency accounts built to reduce restrictions and support stable scaling.</p>
            <ul class="space-y-2 mb-8 text-sm text-gray-500">
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Affordable rates starting from 0%</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Supports diverse campaign types</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>No account setup fee</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>All-in-one package included: BM, Page, Pixel, Profile</li>
            </ul>
            <button class="btn btn-secondary btn-md">
                <span>Discovery</span>
                <img src="/assets/icon_arrow_btn_black.svg" class="h-5 ml-2">
        ...
        <div class="p-8 rounded-3xl bg-white card-shadow group">
            ...
            <p class="text-gray-600 text-sm mb-6 line-clamp-3">Scale your TikTok advertising with reliable Agency accounts designed for stability and growth. Minimize ban risks while maximizing your brand’s reach.</p>
            <ul class="space-y-2 mb-8 text-sm text-gray-500">
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Competitive rates from 3%</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Unlimited account access</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>High-stability, ban-resistant ad accounts</li>
            </ul>
            <button class="btn btn-secondary btn-md">
                <span>Discovery</span>
                <img src="/assets/icon_arrow_btn_black.svg" class="h-5 ml-2">
        ...
        <div class="p-8 rounded-3xl bg-white card-shadow group">
            ...
            <p class="text-gray-600 text-sm mb-6 line-clamp-3">Power up your campaigns with premium, pre-warmed ADShift Bing Ad accounts—built to launch faster, optimize spend, and scale without restrictions.</p>
            <ul class="space-y-2 mb-8 text-sm text-gray-500">
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Rates from 7%</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>No minimum spend</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Compatible with all products</li>
                    <li class="flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Dedicated account manager</li>
            </ul>
            <button class="btn btn-secondary btn-md">
                <span>Discovery</span>
                <img src="/assets/icon_arrow_btn_black.svg" class="h-5 ml-2">
    ...
    <div class="container mx-auto gradient-secondary rounded-3xl p-8 md:p-16 relative overflow-hidden">
        <div class="relative z-10 max-w-2xl">
            ...
            <p class="text-gray-600 mb-8 leading-relaxed">
                If you're dealing with account restrictions, inconsistent performance, or scaling limitations, it's time to move to a more robust and scalable advertising solution.
            </p>
        ...
        <div class="absolute right-0 bottom-0 w-1/2 h-full opacity-50 pointer-events-none hidden md:block">
             <div class="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
             <div class="absolute bottom-[10%] right-[20%] w-[300px] h-[300px] bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
        </div>
    </div>
</section>`,f=`<div class="group cursor-pointer">
    <div class="h-56 bg-gray-200 rounded-xl overflow-hidden mb-4">
...
</div>`;document.querySelector("#header-placeholder").innerHTML=m;document.querySelector("#footer-placeholder").innerHTML=b;const i=document.querySelector("#solutions-component");i&&(i.innerHTML=g);const l=document.querySelector("#blog-list");l&&(l.innerHTML=f.repeat(3));const r=document.querySelector("#cta-component");r&&(r.innerHTML=v);const o=document.querySelector("#process-component");o&&(o.innerHTML=p);const c=document.querySelector("#stats-component");c&&(c.innerHTML=x);const d=document.querySelector("#testimonials-component");d&&(d.innerHTML=h);

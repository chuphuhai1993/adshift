...
</section>`,ge=`<!-- Testimonials Section -->
<section class="">
...
</section>`,pe=`<section class="py-20">
...
</section>`,be=`<div class="container mx-auto px-4 relative z-10">
    <div class="mb-12">
        <div class="flex items-center">
            <img src="assets/icon_title.svg" class="h-5 mr-2">
...
</div>`,he=`<section class="py-20 px-4">
...
`,xe=`<div class="flex flex-col sm:flex-row gap-6 items-start pb-8 border-b border-gray-100 last:border-0 last:pb-0">

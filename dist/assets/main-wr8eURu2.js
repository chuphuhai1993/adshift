...
`,le=`<header id="simple-header" class="fixed top-0 left-0 right-0 z-50 p-4 transition-transform duration-300">
...
`,ce=`<footer class="bg-[#F5F6F7] text-gray-600 pt-16 pb-8 border-t border-gray-200 mt-auto">
...
</section>`,ue=`<!-- Testimonials Section -->
<section class="">
...
</section>`,me=`<section class="py-20">
...
</section>`,ge=`<div class="container mx-auto px-4 relative z-10">
    <div class="mb-12">
        <div class="flex items-center">
            <img src="assets/icon_title.svg" class="h-5 mr-2">
...
</div>`,pe=`<section class="py-20 px-4">
...
`,be=`<a href="#" class="flex gap-4 group">
...
`,he=`<div class="flex flex-col sm:flex-row gap-6 items-start pb-8 border-b border-gray-100 last:border-0 last:pb-0">
...
`;function fe(e){return`
  ...
  `}function ve(e,t,a=!1){return`
    ...
    `}function ye(e,t){const a=t.map(o=>ve(o.question,o.answer,o.isOpen)).join("");return`
    ...
    `}const k=document.querySelector("#header-placeholder");if(k){k.innerHTML=re;const e=document.getElementById("mobile-menu-btn"),t=document.getElementById("close-mobile-menu-btn"),a=document.getElementById("mobile-menu"),o=document.querySelectorAll(".mobile-accordion-btn");e&&a&&e.addEventListener("click",()=>{a.classList.remove("translate-x-full"),document.body.style.overflow="hidden"}),t&&a&&t.addEventListener("click",()=>{a.classList.add("translate-x-full"),document.body.style.overflow=""}),o&&o.forEach(s=>{s.addEventListener("click",()=>{s.classList.toggle("active");const n=s.nextElementSibling;n&&(s.classList.contains("active")?(n.classList.remove("max-h-0"),n.classList.add("max-h-[500px]")):(n.classList.remove("max-h-[500px]"),n.classList.add("max-h-0")))})})}const A=document.querySelector("#simple-header-placeholder");if(A){A.innerHTML=le;const e=document.getElementById("simple-header");e&&window.addEventListener("scroll",()=>{window.scrollY>50?e.classList.add("-translate-y-full"):e.classList.remove("-translate-y-full")})}const E=document.querySelector("#footer-placeholder");E&&(E.innerHTML=ce);const S=document.querySelector("#solutions-component");S&&(S.innerHTML=ge);const L=document.querySelector("#post-list-main-page");L&&(L.innerHTML=i.repeat(3));const M=document.querySelector("#post-list-blog-google");M&&(M.innerHTML=i.repeat(6));const T=document.querySelector("#post-list-blog-page");T&&(T.innerHTML=i.repeat(12));const B=document.querySelector("#post-list-blog-meta");B&&(B.innerHTML=i.repeat(6));const q=document.querySelector("#post-list-blog-tiktok");q&&(q.innerHTML=i.repeat(6));const j=document.querySelector("#post-list-blog-bing");j&&(j.innerHTML=i.repeat(6));const I=document.querySelector("#post-list-detail-page");I&&(I.innerHTML=i.repeat(3));const H=document.querySelector("#post-sidebar-list-detail-page");H&&(H.innerHTML=be.repeat(3));const C=document.querySelector("#author-post-list");C&&(C.innerHTML=he.repeat(5));const _=document.querySelector("#cta-component");_&&(_.innerHTML=pe);const D=document.querySelector("#process-component");D&&(D.innerHTML=de);const P=document.querySelector("#stats-component");P&&(P.innerHTML=me,we());const O=document.querySelector("#testimonials-component");O&&(O.innerHTML=ue);const F=document.querySelector("#partner-grid");if(F){const e=[{type:"Marketing Partner",name:"Google Ads",description:"Strategic partner for search and display advertising solutions, providing cutting-edge tools and insights to maximize campaign performance.",logoHtml:'<img src="assets/google_logo_11.svg" class="h-8" alt="Google Ads">'},{type:"Marketing Partner",name:"Meta Ads",description:"Official partner for social media marketing across Facebook and Instagram platforms, helping businesses reach their target audience effectively.",logoHtml:'<i class="fab fa-facebook text-blue-600 text-3xl"></i>'},{type:"Strategic Partner",name:"TikTok Ads",description:"Specialized agency partner for short-form video advertising and creative strategy on the TikTok platform.",logoHtml:'<i class="fab fa-tiktok text-black text-3xl"></i>'}];F.innerHTML=e.map(t=>xe(t)).join("")}const R=document.querySelector("#case-study-grid");if(R){const e=[{category:"E-commerce",logo:"assets/logo_partner_tiktok.png",title:"Fashion Brand Growth",description:"Scaled a local fashion brand to international markets using TikTok Shop and strategic creator collaborations.",stats:{cpm:"$2.45",cpa:"$12.20",roas:"4.5x"}},{category:"Education",logo:"assets/logo_partner_google.png",title:"EdTech Enrollment",description:"Increased student enrollment for an online learning platform through targeted Search and YouTube campaigns.",stats:{cpm:"$15.80",cpa:"$45.00",roas:"3.2x"}},{category:"Game",logo:"assets/logo_partner_meta.png",title:"Mobile Game Launch",description:"Drove over 1 million downloads in the first month using Meta Advantage+ campaigns and high-performing video creatives.",stats:{cpm:"$5.20",cpa:"$0.85",roas:"2.8x"}},{category:"E-commerce",logo:"assets/logo_partner_google.png",title:"Tech Gadgets Scale",description:"Optimized PMax campaigns to double revenue while maintaining the same advertising spend for a tech retailer.",stats:{cpm:"$8.15",cpa:"$22.40",roas:"5.1x"}},{category:"Game",logo:"assets/logo_partner_tiktok.png",title:"RPG User Acquisition",description:"Implemented specialized bidding strategies to acquire high-LTV players for a new fantasy RPG title.",stats:{cpm:"$12.30",cpa:"$3.50",roas:"3.8x"}},{category:"Education",logo:"assets/logo_partner_meta.png",title:"Language App Expansion",description:"Expanded market reach to Southeast Asia with localized creative content and audience targeting.",stats:{cpm:"$4.10",cpa:"$1.20",roas:"4.2x"}}];R.innerHTML=e.map(t=>fe(t)).join("")}const G=document.querySelector("#toc-toggle"),$=document.querySelector("#toc-content"),z=document.querySelector("#toc-icon");G&&$&&z&&G.addEventListener("click",()=>{$.classList.toggle("hidden"),z.classList.toggle("rotate-180")});const W=document.getElementById("edit-customer-info-btn"),g=document.getElementById("customer-info-modal"),N=document.getElementById("save-customer-info-btn"),U=document.getElementById("cancel-customer-info-btn"),V=document.getElementById("modal-backdrop");if(W&&g){const e=t=>{t?g.classList.remove("hidden"):g.classList.add("hidden")};W.addEventListener("click",t=>{t.preventDefault(),e(!0)}),U&&U.addEventListener("click",()=>e(!1)),V&&V.addEventListener("click",()=>e(!1)),N&&N.addEventListener("click",()=>{e(!1)})}const J=document.getElementById("edit-order-info-btn"),p=document.getElementById("order-info-modal"),Y=document.getElementById("save-order-info-btn"),X=document.getElementById("cancel-order-info-btn"),Z=document.getElementById("close-order-modal-btn"),K=document.getElementById("order-modal-backdrop");if(J&&p){const e=t=>{t?(p.classList.remove("hidden"),document.body.style.overflow="hidden"):(p.classList.add("hidden"),document.body.style.overflow="")};J.addEventListener("click",t=>{t.preventDefault(),e(!0)}),X&&X.addEventListener("click",()=>e(!1)),Z&&Z.addEventListener("click",()=>e(!1)),K&&K.addEventListener("click",()=>e(!1)),Y&&Y.addEventListener("click",()=>{e(!1)})}const c=document.getElementById("toggle-tkqc-btn"),d=document.getElementById("tkqc-details"),b=document.getElementById("toggle-icon");c&&d&&b&&c.addEventListener("click",()=>{d.classList.contains("hidden")?(d.classList.remove("hidden"),b.classList.remove("rotate-180"),c.querySelector("span").textContent="Đóng"):(d.classList.add("hidden"),b.classList.add("rotate-180"),c.querySelector("span").textContent="Mở chi tiết")});function we(){const e=new IntersectionObserver(a=>{a.forEach(o=>{o.isIntersecting&&(o.target.querySelectorAll(".js-counter").forEach(n=>{const r=parseFloat(n.getAttribute("data-target")),h=n.getAttribute("data-prefix")||"",f=n.getAttribute("data-suffix")||"",x=parseInt(n.getAttribute("data-decimals")||"0"),te=2e3,v=0,ne=performance.now();function y(se){const ae=se-ne,w=Math.min(ae/te,1),oe=1-Math.pow(1-w,4),ie=v+(r-v)*oe;n.innerText=h+ie.toFixed(x)+f,w<1?requestAnimationFrame(y):n.innerText=h+r.toFixed(x)+f}requestAnimationFrame(y)}),e.unobserve(o.target))})},{threshold:.2}),t=document.querySelector("#stats-component");t&&e.observe(t)}const ke=[{question:"1. Why use an ADShift Agency Account?",answer:"ADShift Agency accounts provide a layer of trust and stability that standard accounts cannot match. We help you scale faster with higher spending limits, lower suspension risks, and direct support from our team.",isOpen:!1},{question:"2. What does it cost to use a Google Ads Agency account?",answer:"ADShift offers highly competitive pricing, starting from just 3.5% of your total top-up. There are no setup fees or hidden charges. This cost-efficient model gives you access to high-performance, fully managed agency accounts that scale smoothly across any business size or industry.",isOpen:!1},{question:"3. Which payment methods are supported?",answer:"We accept multiple payment options for maximum convenience, including Payoneer, Wise, cryptocurrencies, and bank transfers.",isOpen:!1},{question:"4. How quickly can I get started?",answer:"After your payment is completed, we begin the setup process promptly. Your agency account creation typically starts within one business day, with clear updates provided along the way.",isOpen:!1},{question:"5. What level of support do you provide?",answer:"Every client is assigned a dedicated Account Manager available 7 days a week. Our team ensures your campaigns run smoothly and responds quickly to any questions or issues that arise.",isOpen:!1},{question:"6. What happens if an advertising account is suspended or banned?",answer:"If a Google Ads account is suspended, ADShift immediately migrates your remaining balance to a new verified account. This process minimizes disruption, avoids budget loss, and keeps your campaigns running with minimal downtime.",isOpen:!1},{question:"7. How quickly can I get started?",answer:"After your payment is completed, we begin the setup process promptly. Your agency account creation typically starts within one business day, with clear updates provided along the way.",isOpen:!1}],Q=document.querySelector("#faq-component");Q&&(Q.innerHTML=ye("FAQ",ke));document.addEventListener("click",e=>{if(e.target.closest(".btn-increase")){const t=e.target.closest(".flex").querySelector(".quantity-input");t.value=parseInt(t.value)+1}if(e.target.closest(".btn-decrease")){const t=e.target.closest(".flex").querySelector(".quantity-input"),a=parseInt(t.value);a>0&&(t.value=a-1)}});const ee=document.querySelectorAll(".payment-radio"),u=document.getElementById("card-form"),m=document.getElementById("usdt-form");ee.length>0&&ee.forEach(e=>{e.addEventListener("change",t=>{const a=t.target.value;u&&u.classList.add("hidden"),m&&m.classList.add("hidden"),a==="card"&&u?u.classList.remove("hidden"):a==="usdt"&&m&&m.classList.remove("hidden")})});const l=document.querySelector("#usdt-form button");l&&l.addEventListener("click",()=>{const e=document.querySelector("#usdt-form input");if(e){e.select(),document.execCommand("copy");const t=l.innerHTML;l.innerHTML='<svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>',setTimeout(()=>{l.innerHTML=t},2e3)}});

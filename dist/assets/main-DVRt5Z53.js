             ...
             <div class="border-t border-gray-100">
                 ...
                 <div class="max-h-0 transition-all duration-300 ease-in-out overflow-hidden">
                     <div class="space-y-4 pb-4">
                        <a href="services-google.html" class="block text-gray-600 font-medium">Rent Google agency Ads account</a>
                        <a href="services-meta.html" class="block text-gray-600 font-medium">Rent Meta agency Ads account</a>
                        <a href="services-tiktok.html" class="block text-gray-600 font-medium">Rent Tiktok agency Ads account</a>
                        <a href="services-bing.html" class="block text-gray-600 font-medium">Rent Bing agency Ads account</a>
                     </div>
                 </div>
             </div>
...
`,de=`<header id="simple-header" class="fixed top-0 left-0 right-0 z-50 p-4 transition-transform duration-300">
...
`,ue=`<footer class="bg-[#F5F6F7] text-gray-600 pt-16 pb-8 border-t border-gray-200 mt-auto">
...
</section>`,pe=`<!-- Testimonials Section -->
<section class="">
...
</section>`,ge=`<section class="py-20">
...
</section>`,he=`<div class="container mx-auto px-4 relative z-10">
    <div class="mb-12">
        <div class="flex items-center">
            <img src="assets/icon_title.svg" class="h-5 mr-2">
...
</div>`,be=`<section class="py-20 px-4">
...
</section>`,i=`<a href="blog-detail.html">
...
`,fe=`<a href="#" class="flex gap-4 group">
...
`,ve=`<div class="flex flex-col sm:flex-row gap-6 items-start pb-8 border-b border-gray-100 last:border-0 last:pb-0">
...
`;function ne(e){return`
  ...
  `}function ye(e,t,a=!1){return`
    ...
    `}function we(e,t){const a=t.map(o=>ye(o.question,o.answer,o.isOpen)).join("");return`
    ...
    `}const k=document.querySelector("#header-placeholder");if(k){k.innerHTML=ce;const e=document.getElementById("mobile-menu-btn"),t=document.getElementById("close-mobile-menu-btn"),a=document.getElementById("mobile-menu"),o=document.querySelectorAll(".mobile-accordion-btn");e&&a&&e.addEventListener("click",()=>{a.classList.remove("translate-x-full"),document.body.style.overflow="hidden"}),t&&a&&t.addEventListener("click",()=>{a.classList.add("translate-x-full"),document.body.style.overflow=""}),o&&o.forEach(s=>{s.addEventListener("click",()=>{s.classList.toggle("active");const n=s.nextElementSibling;n&&(s.classList.contains("active")?(n.classList.remove("max-h-0"),n.classList.add("max-h-[500px]")):(n.classList.remove("max-h-[500px]"),n.classList.add("max-h-0")))})})}const A=document.querySelector("#simple-header-placeholder");if(A){A.innerHTML=de;const e=document.getElementById("simple-header");e&&window.addEventListener("scroll",()=>{window.scrollY>50?e.classList.add("-translate-y-full"):e.classList.remove("-translate-y-full")})}const E=document.querySelector("#footer-placeholder");E&&(E.innerHTML=ue);const S=document.querySelector("#solutions-component");S&&(S.innerHTML=he);const M=document.querySelector("#post-list-main-page");M&&(M.innerHTML=i.repeat(3));const L=document.querySelector("#post-list-blog-google");L&&(L.innerHTML=i.repeat(6));const T=document.querySelector("#post-list-blog-page");T&&(T.innerHTML=i.repeat(12));const q=document.querySelector("#post-list-blog-meta");q&&(q.innerHTML=i.repeat(6));const B=document.querySelector("#post-list-blog-tiktok");B&&(B.innerHTML=i.repeat(6));const j=document.querySelector("#post-list-blog-bing");j&&(j.innerHTML=i.repeat(6));const I=document.querySelector("#post-list-detail-page");I&&(I.innerHTML=i.repeat(3));const O=document.querySelector("#post-sidebar-list-detail-page");O&&(O.innerHTML=fe.repeat(3));const H=document.querySelector("#author-post-list");H&&(H.innerHTML=ve.repeat(5));const C=document.querySelector("#cta-component");C&&(C.innerHTML=be);const D=document.querySelector("#process-component");D&&(D.innerHTML=me);const _=document.querySelector("#stats-component");_&&(_.innerHTML=ge,ke());const P=document.querySelector("#testimonials-component");P&&(P.innerHTML=pe);const G=document.querySelector("#partner-grid");if(G){const e=[{type:"Marketing Partner",name:"Google Ads",description:"Strategic partner for search and display advertising solutions, providing cutting-edge tools and insights to maximize campaign performance.",logoHtml:'<img src="assets/google_logo_11.svg" class="h-8" alt="Google Ads">'},{type:"Marketing Partner",name:"Meta Ads",description:"Official partner for social media marketing across Facebook and Instagram platforms, helping businesses reach their target audience effectively.",logoHtml:'<i class="fab fa-facebook text-blue-600 text-3xl"></i>'},{type:"Strategic Partner",name:"TikTok Ads",description:"Specialized agency partner for short-form video advertising and creative strategy on the TikTok platform.",logoHtml:'<i class="fab fa-tiktok text-black text-3xl"></i>'}];G.innerHTML=e.map(t=>xe(t)).join("")}const F=document.querySelector("#case-study-grid");if(F){const e=[{category:"E-commerce",logo:"assets/logo_partner_tiktok.png",title:"Fashion Brand Growth",description:"Scaled a local fashion brand to international markets using TikTok Shop and strategic creator collaborations.",stats:{cpm:"$2.45",cpa:"$12.20",roas:"4.5x"}},{category:"Education",logo:"assets/logo_partner_google.png",title:"EdTech Enrollment",description:"Increased student enrollment for an online learning platform through targeted Search and YouTube campaigns.",stats:{cpm:"$15.80",cpa:"$45.00",roas:"3.2x"}},{category:"Game",logo:"assets/logo_partner_meta.png",title:"Mobile Game Launch",description:"Drove over 1 million downloads in the first month using Meta Advantage+ campaigns and high-performing video creatives.",stats:{cpm:"$5.20",cpa:"$0.85",roas:"2.8x"}},{category:"E-commerce",logo:"assets/logo_partner_google.png",title:"Tech Gadgets Scale",description:"Optimized PMax campaigns to double revenue while maintaining the same advertising spend for a tech retailer.",stats:{cpm:"$8.15",cpa:"$22.40",roas:"5.1x"}},{category:"Game",logo:"assets/logo_partner_tiktok.png",title:"RPG User Acquisition",description:"Implemented specialized bidding strategies to acquire high-LTV players for a new fantasy RPG title.",stats:{cpm:"$12.30",cpa:"$3.50",roas:"3.8x"}},{category:"Education",logo:"assets/logo_partner_meta.png",title:"Language App Expansion",description:"Expanded market reach to Southeast Asia with localized creative content and audience targeting.",stats:{cpm:"$4.10",cpa:"$1.20",roas:"4.2x"}}];F.innerHTML=e.map(t=>ne(t)).join("")}const $=document.querySelector("#related-case-studies-grid");if($){const e=[{category:"E-commerce",logo:"assets/logo_partner_tiktok.png",title:"Fashion Brand Growth",description:"Scaled a local fashion brand to international markets using TikTok Shop and strategic creator collaborations.",stats:{cpm:"$2.45",cpa:"$12.20",roas:"4.5x"}},{category:"Education",logo:"assets/logo_partner_google.png",title:"EdTech Enrollment",description:"Increased student enrollment through targeted Search and YouTube campaigns.",stats:{cpm:"$15.80",cpa:"$45.00",roas:"3.2x"}},{category:"Game",logo:"assets/logo_partner_meta.png",title:"Mobile Game Launch",description:"Over 1M downloads using Advantage+ campaigns and high-performing creatives.",stats:{cpm:"$5.20",cpa:"$0.85",roas:"2.8x"}}];$.innerHTML=e.map(t=>ne(t)).join("")}const R=document.querySelector("#toc-toggle"),W=document.querySelector("#toc-content"),z=document.querySelector("#toc-icon");R&&W&&z&&R.addEventListener("click",()=>{W.classList.toggle("hidden"),z.classList.toggle("rotate-180")});const N=document.getElementById("edit-customer-info-btn"),p=document.getElementById("customer-info-modal"),U=document.getElementById("save-customer-info-btn"),V=document.getElementById("cancel-customer-info-btn"),J=document.getElementById("modal-backdrop");if(N&&p){const e=t=>{t?p.classList.remove("hidden"):p.classList.add("hidden")};N.addEventListener("click",t=>{t.preventDefault(),e(!0)}),V&&V.addEventListener("click",()=>e(!1)),J&&J.addEventListener("click",()=>e(!1)),U&&U.addEventListener("click",()=>{e(!1)})}const Y=document.getElementById("edit-order-info-btn"),g=document.getElementById("order-info-modal"),X=document.getElementById("save-order-info-btn"),Z=document.getElementById("cancel-order-info-btn"),K=document.getElementById("close-order-modal-btn"),Q=document.getElementById("order-modal-backdrop");if(Y&&g){const e=t=>{t?(g.classList.remove("hidden"),document.body.style.overflow="hidden"):(g.classList.add("hidden"),document.body.style.overflow="")};Y.addEventListener("click",t=>{t.preventDefault(),e(!0)}),Z&&Z.addEventListener("click",()=>e(!1)),K&&K.addEventListener("click",()=>e(!1)),Q&&Q.addEventListener("click",()=>e(!1)),X&&X.addEventListener("click",()=>{e(!1)})}const c=document.getElementById("toggle-tkqc-btn"),d=document.getElementById("tkqc-details"),h=document.getElementById("toggle-icon");c&&d&&h&&c.addEventListener("click",()=>{d.classList.contains("hidden")?(d.classList.remove("hidden"),h.classList.remove("rotate-180"),c.querySelector("span").textContent="Đóng"):(d.classList.add("hidden"),h.classList.add("rotate-180"),c.querySelector("span").textContent="Mở chi tiết")});function ke(){const e=new IntersectionObserver(a=>{a.forEach(o=>{o.isIntersecting&&(o.target.querySelectorAll(".js-counter").forEach(n=>{const r=parseFloat(n.getAttribute("data-target")),b=n.getAttribute("data-prefix")||"",f=n.getAttribute("data-suffix")||"",v=parseInt(n.getAttribute("data-decimals")||"0"),se=2e3,x=0,ae=performance.now();function y(oe){const ie=oe-ae,w=Math.min(ie/se,1),re=1-Math.pow(1-w,4),le=x+(r-x)*re;n.innerText=b+le.toFixed(v)+f,w<1?requestAnimationFrame(y):n.innerText=b+r.toFixed(v)+f}requestAnimationFrame(y)}),e.unobserve(o.target))})},{threshold:.2}),t=document.querySelector("#stats-component");t&&e.observe(t)}const Ae={google:[{question:"1. Why partner with ADShift for Google Ads?",answer:"ADShift combines deep industry expertise, direct media relationships, and localized support to remove common advertising barriers. We help you run compliant, stable, and scalable campaigns built for long-term growth. Beyond accounts, we provide the infrastructure, hands-on support, guidance, and tools you need to succeed — because your success is our success.",isOpen:!1},{question:"2. What does it cost to use a Google Ads Agency account?",answer:"ADShift offers highly competitive pricing, starting from just 3.5% of your total top-up. There are no setup fees or hidden charges. This cost-efficient model gives you access to high-performance, fully managed agency accounts that scale smoothly across any business size or industry.",isOpen:!1},{question:"3. Which payment methods are supported?",answer:"We accept multiple payment options for maximum convenience, including Payoneer, Wise, cryptocurrencies, and bank transfers.",isOpen:!1},{question:"4. How quickly can I get started?",answer:"After your payment is completed, we begin the setup process promptly. Your agency account creation typically starts within one business day, with clear updates provided along the way.",isOpen:!1},{question:"5. What level of support do you provide?",answer:"Every client is assigned a dedicated Account Manager available 7 days a week. Our team ensures your campaigns run smoothly and responds quickly to any questions or issues that arise.",isOpen:!1},{question:"6. What happens if an advertising account is suspended or banned?",answer:"If a Google Ads account is suspended, ADShift immediately migrates your remaining balance to a new verified account. This process minimizes disruption, avoids budget loss, and keeps your campaigns running with minimal downtime.",isOpen:!1}],meta:[{question:"1. What sets ADShift's Meta agency accounts apart?",answer:"These partner-level Meta accounts are built for scale, allowing advertisers to grow without worrying about spending limits or sudden thresholds.",isOpen:!1},{question:"2. How much does it cost to rent a Facebook agency ad account?",answer:"Pricing depends on the service scope and rental terms. Service fees typically start from 3% of your top-up and may vary based on spend volume. We also offer preferential rates for businesses and high-spending clients.",isOpen:!1},{question:"3. What payment methods are available?",answer:"ADShift supports multiple payment options for your convenience, including Payoneer, Wise, cryptocurrencies, and bank transfers.",isOpen:!1},{question:"4. Can I join as an agency?",answer:"Absolutely. We collaborate with many agencies and provide white-label solutions, enabling you to offer our ad accounts to your own clients. Our Sales Partner program helps you expand your service offerings or launch a new business line with ease. Contact us directly to learn more about partnership benefits.",isOpen:!1},{question:"5. How quickly can we get started?",answer:"Once payment is completed, we move fast. Account setup begins within one business day, and we’ll keep you updated throughout the process.",isOpen:!1},{question:"6. What level of support will I receive?",answer:"Every ADShift client is assigned a dedicated Account Manager, available seven days a week to assist with questions or issues—ensuring smooth campaign execution and rapid problem resolution.",isOpen:!1}],tiktok:[{question:"1. What makes ADShift's TikTok invoice account unique?",answer:"This is a partner-level TikTok account designed for scale, allowing advertisers to grow freely without worrying about spending caps or threshold limits.",isOpen:!1},{question:"2. How much does it cost to rent a TikTok agency ad account?",answer:"Pricing depends on the service scope and applicable taxes. Service fees typically start from around 2% and decrease as your top-up volume increases.",isOpen:!1},{question:"3. Which payment methods are supported?",answer:"ADShift accepts multiple payment options for convenience, including Payoneer, Wise, cryptocurrencies, and bank transfers.",isOpen:!1},{question:"4. Can I join as an agency?",answer:"Absolutely. We work closely with many agencies and offer white-label solutions, enabling you to resell our ad accounts to your clients. Our Sales Partner program helps you expand your services or launch a new business line with ease. Contact us directly to learn more about partnership benefits.",isOpen:!1},{question:"5. How quickly can we get started?",answer:"Once payment is completed, we begin the setup process promptly. Account creation starts within one business day, with regular updates provided throughout.",isOpen:!1},{question:"6. What level of support will I receive?",answer:"Every ADShift client is assigned a dedicated Account Manager, available seven days a week to assist with any questions or issues—ensuring smooth campaign performance and fast problem resolution.",isOpen:!1}],bing:[{question:"1. Why should I work with ADShift?",answer:"ADShift combines proven expertise, direct media partnerships, and localized support to remove common advertising barriers. We help you run compliant, stable, and scalable campaigns built for long-term growth. Beyond ad accounts, we provide the infrastructure, guidance, training, and tools you need—because your success drives ours.",isOpen:!1},{question:"2. How much does it cost to rent a Bing Ads agency account?",answer:"Our Bing Ads agency accounts start from just 7% of your top-up amount. There are no setup costs or hidden fees, making it a budget-friendly solution for businesses of any size looking to scale efficiently.",isOpen:!1},{question:"3. Which payment methods are accepted?",answer:"We support bank transfers, digital banking solutions, and cryptocurrency payments, including USDT.",isOpen:!1},{question:"4. How quickly can I get started?",answer:"After completing registration, we move fast. Account setup begins within one business day, and we’ll keep you informed throughout the process.",isOpen:!1},{question:"5. What level of support will I receive?",answer:"Every ADShift client is assigned a dedicated Account Manager available seven days a week. Our hands-on support ensures smooth campaign execution and quick resolution of any issues that arise.",isOpen:!1}]},ee=document.querySelector("#faq-component");if(ee){const e=window.location.pathname||"";let t="google";e.endsWith("services-meta.html")?t="meta":e.endsWith("services-tiktok.html")?t="tiktok":e.endsWith("services-bing.html")&&(t="bing"),ee.innerHTML=we("FAQ",Ae[t])}document.addEventListener("click",e=>{if(e.target.closest(".btn-increase")){const t=e.target.closest(".flex").querySelector(".quantity-input");t.value=parseInt(t.value)+1}if(e.target.closest(".btn-decrease")){const t=e.target.closest(".flex").querySelector(".quantity-input"),a=parseInt(t.value);a>0&&(t.value=a-1)}});const te=document.querySelectorAll(".payment-radio"),u=document.getElementById("card-form"),m=document.getElementById("usdt-form");te.length>0&&te.forEach(e=>{e.addEventListener("change",t=>{const a=t.target.value;u&&u.classList.add("hidden"),m&&m.classList.add("hidden"),a==="card"&&u?u.classList.remove("hidden"):a==="usdt"&&m&&m.classList.remove("hidden")})});const l=document.querySelector("#usdt-form button");l&&l.addEventListener("click",()=>{const e=document.querySelector("#usdt-form input");if(e){e.select(),document.execCommand("copy");const t=l.innerHTML;l.innerHTML='<svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>',setTimeout(()=>{l.innerHTML=t},2e3)}});
